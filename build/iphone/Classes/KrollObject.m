...
//@interface Program3Object : NSObject
//@end

@interface Program3Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Program3Object class]])
		{
			for (NSString *key in [[(Program3Object*)o modules] allKeys])
			{
