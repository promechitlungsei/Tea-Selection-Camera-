...
/**
 The base class for all Program3 modules
 */
...
/**
 Program3 Platform calls this method on startup.
 */
-(void)startup;

/**
 Program3 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Program3 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Program3 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Program3 Platform calls this method on resume.
 @param sender The sender of the event.
 */
