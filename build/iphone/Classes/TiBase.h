...
// in simulator we redefine to format for Program3 Developer console
...
{\
	NSString * exceptionName = [@"org.program3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.program3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIProgram3NativeItemNone = -1, 
	UIProgram3NativeItemSpinner = -2,
	UIProgram3NativeItemProgressBar = -3,
	
	UIProgram3NativeItemSlider = -4,
	UIProgram3NativeItemSwitch = -5,
	UIProgram3NativeItemMultiButton = -6,
	UIProgram3NativeItemSegmented = -7,
	
	UIProgram3NativeItemTextView = -8,
	UIProgram3NativeItemTextField = -9,
	UIProgram3NativeItemSearchBar = -10,
	
	UIProgram3NativeItemPicker = -11,
	UIProgram3NativeItemDatePicker = -12,
	
	UIProgram3NativeItemInfoLight = -13,
	UIProgram3NativeItemInfoDark = -14,
	
	UIProgram3NativeItemDisclosure = -15,
	
	UIProgram3NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Program3 instances of
